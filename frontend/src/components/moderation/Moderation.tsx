...
export default function Moderation({ 
    ...
    // Handle the rejection of a recipe
    const handleRejectRecipe = () => {
        onRejectRecipe();
        updateActionButtons([]); 
    };

    // Handle changes in the basic information of the recipe (title, description)
    const handleChangeBasicInfo = (field: keyof Recipe, value: string) => {
        setEditedRecipe(prev => ({ ...prev, [field]: value }));
        console.log(`Updated ${field}:`, value);
    };

    // Handle changes in the ingredients of the recipe
    ...
    // Handle changes in the steps of the recipe
    ...
    // Handle changes in the category of the ingredients
    ...
    // Handle changes in the "isMain" field of the ingredients
    ...
    // Handle changes in radio buttons (dish type, cuisine, cooking time, need side dish)
    ...
    // Handle changes in checkboxes (seasons, dinner times, dinner categories)
    ...
    // Handle the publishing of the recipe
    const handlePublish = () => {
        ...
        <div>
            ...
            <div className="moderation-card-container">
                <div className="moderation-card common-card narrow">
                    ...
                    <div>
                        {['Appetizer', 'Salad', 'Starter', 'Hot starter', 'Soup', 'Main dish', 'Side dish', 'Desert'].map((type, idx) => (
