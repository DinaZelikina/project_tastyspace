...
export default function CreateMenuQuestions({ updateActionButtons }: CreateMenuQuestionsProps) {
    ...
    // Reset all question states and set initial step
    ...
    // Update dinner time options based on selected dinner category
    useEffect(() => {
    ...
    // Update cooking time options based on selected dinner category and time
    useEffect(() => {
    ...
    // Automatically create a menu when all three selections are made
    useEffect(() => {
    ...
    // Create a menu based on selected options and fetch the corresponding recipes
    const createMenu = () => {
    ...
    // Handle the display of the shopping list
    ...
    // Handle the display of the recipe list
    ...
    // Handle the recreate menu action
    const handleRecreateMenu = () => {
        createMenu();
    };

    // Proceed to the next question step
